...
Найти все полупути длины h между висячими вершинами, где h — высота дерева.
Выбрать корни этих полупутей, которые расположены на максимальной глубине, и удалить (правым удалением) тот из них, который является средним по значению.
...
tst.in:
10 8 16 7 9 13 17 12 14

tst.out:
10 8 7 9 17 13 12 14
